define(function (require,exports,module) {
    ...
    function zeptolize(name) {
        ...
        $.fn[key]=function (opts) {
            ...
            $.each(this,function (i,el) {
                ...
                // 从缓存中取，没有则创建一个
                obj=record(el,name)||new sl[name](el,
    ...
    */
    ...
    /**
    * @method define
    * @grammar sl.define( name, object[, superClass] )
    * @class
    ...
    *
    */
    sl.define=function (name,object,superClass) {
        sl[name]=createClass(name,object,superClass);
        zeptolize(name);
    };
    ...
    * @method isWidget
    * @grammar sl.isWidget( anything[, klass] ) => Boolean
    * @param {*} anything 需要判断的对象
    * @param {String|Class} klass 字符串或者类。
    * @example
    * var a = new sl.Button();
    *
    * console.log( sl.isWidget( a ) );    // => true
    * console.log( sl.isWidget( a, 'Dropmenu' ) );    // => false
    */
    sl.isWidget=function (obj,klass) {

        // 处理字符串的case
        klass=typeof klass==='string'?sl[klass]||blankFn:klass;
        klass=klass||sl.Base;
    ...
    sl.Base=createClass('Base',{
        ...
        */
        trigger: function (name) {
            var evt=typeof name==='string'?new sl.Event(name):name,
