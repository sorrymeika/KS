define(function (require,exports,module) {
    ...
    util.addStyle('.calendar{height:22px;padding:1px;zoom:1;display:inline-block;*display:inline;position:relative;overflow:visible;z-index:0;color:#000;}\
        .calendar span {cursor:pointer;border:0;margin:0;padding:0 2px;height:20px;width:12px;line-height:20px;display:inline-block;position:relative;color:#000;background-color:#f1f1f1;}\
