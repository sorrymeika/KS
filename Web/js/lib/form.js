define(function (require,exports,module) {
    ...
    var Control=function (form,options) {
        ...
        var inputValid=opt.validation,
            ...
            type=opt.type,
            value=opt.value,
            emptyAble=typeof opt.emptyAble=="undefined"?!inputValid||inputValid.emptyAble:opt.emptyAble;
            ...
            if($.isFunction(opt.render)) {
                ...
                'insertunorderedlist','|','emoticons','image','link']
                    ...
                    if(opt.type=="textarea") {
                        ...
                        input=$('<input type="'+type+'" name="'+name+'"'+(opt.className?' class="'+opt.className+'"':opt.type=='text'?' class="text"':opt.type=='password'?' class="text_normal"':'')+'/>');
                    }
